...
class AuthTables extends Migration
{
	public function up()
	{
		...
		$this->forge->addField([
			'id'          => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true],
			'parent_id'   => ['type' => 'int', 'constraint' => 11, 'null' => true, 'default' => 0],
			'order'       => ['type' => 'int', 'constraint' => 11, 'null' => true, 'default' => 0],
			'title'       => ['type' => 'varchar', 'constraint' => 50, 'null' => true],
			'icon'        => ['type' => 'varchar', 'constraint' => 50, 'null' => true],
			'uri'         => ['type' => 'varchar', 'constraint' => 50, 'null' => true],
			'routes'      => ['type' => 'varchar', 'constraint' => 256, 'null' => true],
			'created_at'       => ['type' => 'datetime', 'null' => true],
			'updated_at'       => ['type' => 'datetime', 'null' => true],
		]);
		$this->forge->addKey('id', true);
		$this->forge->createTable('auth_menus', true);


		/**
		 * Activations auth_roles_menus
		 */
		$this->forge->addField([
		...
		$this->forge->addKey('id', true);
		$this->forge->createTable('auth_roles_menus');

		/**
		 * Activations auth_roles_users
		*/
		$this->forge->addField([
			'user_id'         => ['type' => 'int', 'constraint' => 11],
			'role_id'         => ['type' => 'int', 'constraint' => 11],
		...
		$this->forge->addKey('id', true);
		$this->forge->createTable('auth_roles_users');
	...
	public function down()
	{
		...
		$this->forge->dropTable('auth_menus', true);
		$this->forge->dropTable('auth_role_menu', true);
	}
}
